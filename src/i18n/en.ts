...
export const en = {
  ...
  mediaCenter: {
    ...
    requests: "Requests",
    downloads: "Downloads",
    overseerrRequests: "Requests from Overseerr",
    automationActivity: "Sonarr and Radarr activity",
    activityTracked: "Tracked",
    activitySearching: "Searching",
    activityQueued: "Queued",
    activityImporting: "Importing",
    ...
    manualReleaseSearch: "Manual torrent search",
    manualReleaseSearchHint: "Show raw Prowlarr results and why Sonarr or Radarr rejected them.",
    releaseQuery: "Release search phrase",
